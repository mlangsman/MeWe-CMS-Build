 ...
 * @package 	Solspace:User
 * @author		Solspace DevTeam
 * @filesource 	./system/expressionengine/third_party/user/ext.user.base.php
 */

require_once 'addon_builder/extension_builder.php';

class User_extension_base extends Extension_builder_user
{
	public $name				= "User";
	public $version				= "";
	public $description			= "";
	...
	public function publish_form_new_tabs_block( $channel_id = '' )
    {	
    	ee()->lang->loadfile('user');
    ...
    // END publish_form_new_tabs_block()
    
	// --------------------------------------------------------------------

	/**
	 *	Submit New Entry Routine
	 *
	 *	@access		public
	 *	@param		integer
	 *	@return		null
	...
	/**
	 *	User Authors - Sessions End, Used for AJAX
	 *
	 *	@access		public
	 *	@param		null
	 *	@return		null
	...
	{	
		...
		if ( REQ != 'CP' OR ee()->input->get('solspace_user_ajax') === FALSE)
		{
			return;
		}
