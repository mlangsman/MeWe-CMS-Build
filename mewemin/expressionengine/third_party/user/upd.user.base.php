...
class User_updater_base extends Module_builder_user
{    
...
EOF;
    ...
    public function update()
    {
		...
		if (APP_VER >= 2.0 AND ($this->version_compare($this->database_version(), '<', '3.3.2')))
		{
			...
			if ($tab_channel_ids !== FALSE AND is_array($tab_channel_ids) AND ! empty($tab_channel_ids))
			{
	...
	public function remove_user_tabs()
	{
		...
		ee()->layout->delete_layout_fields(array_merge_recursive($this->old_layout_data, $this->tabs()));
	}
