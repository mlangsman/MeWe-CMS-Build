...
Class Ed_imageresizer
{
    ...
    private $server_path        = '/Applications/MAMP/htdocs/MeWe_CMS'; // no trailing slash
    private $cache_path         = '/Applications/MAMP/htdocs/MeWe_CMS/resize_cache/'; // with trailing slash
