...
//
//  Dick Munroe (munroe@csworks.com) 06-Feb-2006
//        Fix a couple of spots where query was called with a constant value.
//
//  Dick Munroe (munroe@csworks.com) 07-Feb-2006
//      Add getQueryid as a helper for porting to PostgreSQL.
//
//  Dick Munroe (munroe@csworks.com) 21-Apr-2006
//      Move abstract interfaces to a base class.
//
//  Dick Munroe (munroe@csworks.com) 28-Jun-2006
//      Add a new interface that allows the port to use at the host end to be specified.
//      serverHasTransaction has been moved to the abstraction layer.
//      Use abstraction to get connection.
//      Allow fetchRow and fetchAssoc to accept results resources so that SQL can be
//      correctly nested using this object.
//
